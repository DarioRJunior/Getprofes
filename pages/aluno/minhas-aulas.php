...
$sql = "SELECT * FROM aulas WHERE id_aluno = '" . $_SESSION['id_usuario'] . "'";
$query_aulas = "SELECT COUNT(id) AS qnt_aulas FROM aulas WHERE id_aluno = '" . $_SESSION['id_usuario'] . "'";

if (isset($_GET['pagina'])) {
    $pag = $_GET['pagina'];
    $busca = "SELECT * FROM aulas WHERE id_aluno = '" . $_SESSION['id_usuario'] . "'";
