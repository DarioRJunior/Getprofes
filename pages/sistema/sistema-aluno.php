...
<body>
    ...
    <div id="bem-vindo">
        <p>SISTEMA DO ALUNO(A)</p>
        <P>Bem-vindo, Aluno(a) <?php echo $_SESSION["nome"]; ?>!</P>
    </div>
    ...
    <div id="modal-sair" class="modal-container">
        <div class="modal">
            ...
            <div class="btn-container">
                ...
                <a href="sistema-aluno.php"><button class="btn-nao">NÃO</button></a>
