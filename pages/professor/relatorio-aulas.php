...
$relatorio = "SELECT * FROM aulas WHERE id_professor = '" . $_SESSION['id_usuario'] . "'";
$query_disciplinas = "SELECT COUNT(id) AS qnt_aulas FROM aulas WHERE id_professor = '" . $_SESSION['id_usuario'] . "'";
...
$pdf->Cell(40, 10, utf8_decode('Aluno'), 1, 0, 'C');
...
foreach ($con->query($relatorio) as $row) {
    ...
    $pdf->Cell(40, 10, utf8_decode($row['nome_aluno']), 1, 0, 'C');
