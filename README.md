...
## 💻 Objetivo
 ...
 Projeto sendo desenvolvido para matéria de PHP da Unicuritiba. O seguinte projeto tem como objetivo apresentar um sistema com o tema de aulas particulares.

## 🖥️ Instruções de instalação

Copie a pasta do projeto dentro do diretório do htdocs dentro do xampp, com o comando
- git clone https://github.com/DarioRJunior/Getprofes.git
...
- mysql -h localhost -u root -p getprofes < getprofes.sql
